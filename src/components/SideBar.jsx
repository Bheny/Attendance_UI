...
const SideBar = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 20h9M3 20h9m9 0v-9a2 2 0 00-2-2H5a2 2 0 00-2 2v9a2 2 0 002 2h3v-4a1 1 0 011-1h6a1 1 0 011 1v4h3a2 2 0 002-2v-9a2 2 0 00-2-2h-3" />
</svg>
  ...
  <path fillRule="evenodd" d="M6.75 2.25A.75.75 0 017.5 3v1.5h9V3A.75.75 0 0118 3v1.5h.75a3 3 0 013 3v11.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V7.5a3 3 0 013-3H6V3a.75.75 0 01.75-.75zm13.5 9a1.5 1.5 0 00-1.5-1.5H5.25a1.5 1.5 0 00-1.5 1.5v7.5a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5v-7.5z" clipRule="evenodd" />
    ...
    },
    {
      ...
      fa: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0v3m0 0l-9-5 9-5 9 5-9 5z" />
      </svg>
