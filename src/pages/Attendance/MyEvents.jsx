...
const MyEvents = () => {
    ...
    <h2 className='text-2xl font-bold text-gray-800 w-1/2 inline'>Your Events</h2>
    <div className='flex text-sm gap-3'>
        <button className='border px-4 py-1 rounded'><span>
...
</span><span className='hidden'>Filter By</span></button>
    ...
    <div className='mt-8 grid gap-3 grid-cols-2  md:grid-cols-4'>
       {events.map((event, index)=>(
        ...
        <div className='w-full p-4 '>
            <Link to="/event/detail"><button className='bg-blue-600 text-white px-4 py-1 float-right '>View More</button></Link>
